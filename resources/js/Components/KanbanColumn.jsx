...
const COLUMN_CONFIG = {
    pending: {
        ...
        dropHighlight: 'border-slate-400/40 bg-slate-400/5',
    },
    in_progress: {
        label: 'Em Andamento',
        ...
        dropHighlight: 'border-indigo-400/40 bg-indigo-400/5',
    },
    completed: {
        label: 'Concluída',
            ...
            <div
                ...
                className={`flex-1 rounded-xl transition-all duration-200 ${
                    isHighlighted
                        ...
                        : isDragActive
                            ? 'border-2 border-dashed border-white/5 p-1'
                ...
                <div className="space-y-3">
                    {tasks.length === 0 ? (
                        <div className={`text-center py-8 rounded-xl transition-all ${
                            ...
                            {isDragActive ? (
                                <p className={`text-xs ${isHighlighted ? 'text-slate-400' : 'text-slate-600'}`}>

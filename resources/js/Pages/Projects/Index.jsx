        ...
        <AppLayout title="Meus Projetos">
            ...
            {filtered.length === 0 ? (
                <div className="text-center py-24">
                    <div className="w-20 h-20 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/5 flex items-center justify-center mx-auto mb-4 shadow-sm">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-600 mb-6">

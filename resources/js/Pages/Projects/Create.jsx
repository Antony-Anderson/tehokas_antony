...
export default function Create() {
    ...
    const inputClass = "w-full bg-slate-900/50 border border-white/10 rounded-xl py-3 px-4 text-slate-100 placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all";
            ...
            <div className="max-w-2xl">
                ...
                <div className="bg-slate-900/50 border border-white/5 rounded-2xl p-8">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            <h2 className="font-semibold text-slate-100">Criar novo projeto</h2>
                            <p className="text-xs text-slate-500">Preencha as informações do projeto</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            <Link
                                href="/projects"
                                className="flex-1 text-center py-3 rounded-xl border border-white/10 text-sm text-slate-400 hover:text-slate-200 hover:bg-white/5 transition-all"
                            >
                                Cancelar
                            </Link>
                            <button

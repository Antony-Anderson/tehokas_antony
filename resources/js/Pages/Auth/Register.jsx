...
import { Mail, Lock, User, UserPlus, Loader2, ArrowRight, CheckCircle } from 'lucide-react';
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-[#0f172a] text-slate-100 flex items-center justify-center p-4 relative overflow-hidden">
                ...
                {/* Background blobs */}
                <div className="absolute top-[-15%] right-[-5%] w-[45%] h-[45%] rounded-full bg-violet-600/20 blur-[130px] pointer-events-none"></div>
                <div className="absolute bottom-[-15%] left-[-5%] w-[45%] h-[45%] rounded-full bg-indigo-600/20 blur-[130px] pointer-events-none"></div>
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[30%] h-[30%] rounded-full bg-fuchsia-700/10 blur-[100px] pointer-events-none"></div>
                ...
                <div className="w-full max-w-md relative z-10 py-8">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-400">Junte-se e comece sua jornada agora</p>
                    </div>
                    ...
                    <div className="backdrop-blur-xl bg-slate-900/50 p-8 rounded-3xl border border-white/5 shadow-2xl">
                        <form onSubmit={submit} className="space-y-5">
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-slate-300 ml-1 block" htmlFor="name">
                                    Nome Completo
                                </label>
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        name="name"
                                        value={data.name}
                                        className="w-full bg-slate-950/50 border border-white/10 rounded-2xl py-3 pl-12 pr-4 text-slate-100 placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500 transition-all duration-300"
                                ...
                                {errors.name && (
                                    <p className="text-rose-400 text-sm mt-1 ml-1">{errors.name}</p>
                                )}
                            </div>
                            ...
                            {/* Password */}
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-slate-300 ml-1 block" htmlFor="password">
                                    Senha
                                </label>
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-500 group-focus-within:text-violet-400 transition-colors duration-200">
                            ...
                            {/* Confirm Password */}
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-slate-300 ml-1 block" htmlFor="password_confirmation">
                                    Confirmar Senha
                                </label>
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-500 group-focus-within:text-violet-400 transition-colors duration-200">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-950/50 border border-white/10 rounded-2xl py-3 pl-12 pr-14 text-slate-100 placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500 transition-all duration-300"
                                ...
                                {errors.password_confirmation && (
                                    <p className="text-rose-400 text-sm mt-1 ml-1">{errors.password_confirmation}</p>
                                )}
                            </div>
                        ...
                        <p className="mt-5 text-center text-xs text-slate-600">
                            ...
                            <a href="#" className="text-slate-500 hover:text-violet-400 transition-colors underline underline-offset-2">
                                Termos de Uso
                            </a>{' '}
                            e{' '}
                            <a href="#" className="text-slate-500 hover:text-violet-400 transition-colors underline underline-offset-2">

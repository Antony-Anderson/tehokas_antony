...
import { Mail, Lock, LogIn, Loader2, ArrowRight, Sun, Moon } from 'lucide-react';
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-slate-50 dark:bg-[#0f172a] text-slate-900 dark:text-slate-100 flex items-center justify-center p-4 relative overflow-hidden transition-colors duration-200">
                ...
                {/* Background blobs */}
                <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-indigo-500/15 dark:bg-indigo-600/20 blur-[120px] pointer-events-none"></div>
                <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-violet-500/15 dark:bg-violet-600/20 blur-[120px] pointer-events-none"></div>
                            ...
                            <div className="flex items-center pt-2">
                                <label className="flex items-center cursor-pointer group">
                                    <div className="relative flex items-center justify-center">
                                        ...
                                        />
                                        <div className="w-5 h-5 border-2 border-slate-400 dark:border-slate-600 rounded bg-slate-100 dark:bg-slate-900/50 peer-checked:bg-indigo-500 peer-checked:border-indigo-500 transition-all duration-200"></div>
                                    ...
                                    <span className="ml-3 text-sm text-slate-600 dark:text-slate-400 group-hover:text-slate-900 dark:group-hover:text-slate-300 transition-colors">Lembrar de mim</span>
                                </label>
                            </div>
